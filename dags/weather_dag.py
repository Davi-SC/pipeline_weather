...
url = f'https://api.openweathermap.org/data/2.5/weather?q=Coelho Neto,BR&units=metric&appid={API_KEY}'
...
@dag(
    ...
    description = 'Pipeline ETL - Clima em Coelho Neto',
    schedule= '0 */1 * * *',
...
def weather_pipeline():
    ...
    def load():
        ...
        load_weather_data('cn_weather', df)
